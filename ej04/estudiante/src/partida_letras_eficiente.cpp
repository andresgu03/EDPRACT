 ...
 * @brief Programa de prueba del TDA SolverEficiente
...
int main(int argc, char *argv[])
{
    if(argc != 5){
        ...
        // 3) Cargar Solver
        SolverEficiente solver_eficiente(diccionario, letras);
        ...
        soluciones = solver_eficiente.getSolutions(random_letras, jugar_por_punt);
